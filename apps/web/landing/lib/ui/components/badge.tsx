  ...
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-[color,box-shadow] [&>svg]:pointer-events-none [&>svg]:size-3",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary-container text-on-secondary-container [a&]:hover:bg-secondary-container/90",
        destructive:
          "bg-danger text-white [a&]:hover:bg-danger/90",
        outline:
          "border-border text-foreground [a&]:hover:bg-surface-container-low",
        ghost: "[a&]:hover:bg-surface-container-low",
